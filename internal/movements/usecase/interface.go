...
type MovementUsecase interface {
	...
	GetMovementsByYear(ctx context.Context, accountID string, year int) ([]*domain.Movement, error)
	GetMovementsByMonth(ctx context.Context, accountID string, year int, month int) ([]*domain.Movement, error)
